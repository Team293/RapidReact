...
public class SequentialAutoCommand extends SequentialCommandGroup {
    ...
    public SequentialAutoCommand(Drivetrain drivetrain, Kinematics kinematics, Feeder feeder, Targeting targeting, Launcher launcher, StartPositions startPosition) {
        ...
        switch(m_startPosition) { // Changes the robot path based on the starting position of the robot Left, Middle, Right
            case BLUE_LEFT:
                addCommands(
                    ...
                    new ParallelRaceGroup(
                        new Fire(m_feeder, m_launcher),
                        new Wait(3.0)),
                    // Rotate torwards opposing ball
                    new Rotate(m_drivetrain, -90.0),
                    // Drive to the opposing ball and collect it
                    new DriveTo(new Position2D(-7.359, 10.412, Math.toRadians(0)), 2.0d, false, m_kinematics, m_drivetrain),
            ...
            case BLUE_RIGHT:
                addCommands(
                    ...
                    new DriveTo(new Position2D(2.814, -12.436, Math.toRadians(0)), 2.0d, false, m_kinematics, m_drivetrain),
