...
// Create some buttons
    ...
    ballPickUpOnButton.whenPressed(new BallPickUpOn(m_ballPickUp));

    final JoystickButton ballPickUpOffButton = new JoystickButton(m_operatorXboxController, XboxController.Button.kB.value);
    ballPickUpOffButton.whenPressed(new BallPickUpOff(m_ballPickUp));
