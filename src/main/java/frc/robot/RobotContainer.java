...
// Create some buttons
    ...
    final JoystickButton ballPickUpButton = new JoystickButton(m_xboxController, XboxController.Button.kA.value);
    ballPickUpButton.whenPressed(new BallPickUp().ballPickUpOn());
