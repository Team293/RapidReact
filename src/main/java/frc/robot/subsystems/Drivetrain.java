...
public class Drivetrain extends SubsystemBase {
    ...
    private SendableChooser<Command> m_selector;
    // private Drivetrain m_chooseDrive;

    public Drivetrain(Kinematics kinematics, SendableChooser<Command> selector) {
    ...
    public void periodic() {
        ...
        // SmartDashboard.putData(m_chooseDrive);
        SmartDashboard.putData(m_selector);
    }
