...
public class Climb extends SubsystemBase 
{
    ...
    */
    public Climb() {
        ...
        lowPressureClimbSolenoid = new DoubleSolenoid(7,PneumaticsModuleType.REVPH,0, 1);  // 1 0
        highPressureClimbSolenoid = new DoubleSolenoid(7,PneumaticsModuleType.REVPH,2, 3); // 3 2
