...
public class Climb extends SubsystemBase 
{
    ...
    */
    public Climb() 
    {
        ...
        lowPressureClimbSolenoid = new DoubleSolenoid(0, PneumaticsModuleType.CTREPCM, 5, 4);     // needs constants
        highPressureClimbSolenoid = new DoubleSolenoid(0, PneumaticsModuleType.CTREPCM, 3, 2);   // needs constants
